...
- `npm run refresh:all` - sync the full DataSeeds payload mirror, then refresh enriched classes, skills, and spells.
...
- Add markdown-backed enrichment for weapons, armor, mundane gear, feats, class abilities, races, traits, monsters, and item families.

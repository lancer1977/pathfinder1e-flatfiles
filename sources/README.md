...
Use this folder for source inventories, notes, and regeneration inputs.

Do not store application code here.

## Source Notes

- `DataSeeds/pathfinder1e` is the current full payload mirror source for the Pathfinder API data shape.
...
- `pf1-family-shape-index.json` records the canonical PF1 flatfile JSON array shapes.
